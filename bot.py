...
async def show_final_results(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result_text = (
        ...
        "Этот тест — не про «правильные» или «неправильные» реакции. Все способы реагирования на стресс — естественны и имеют свою функцию.\n\n"
        "🔹 Важно не то, как вы реагируете, а то, что вы это осознаёте.\n"
        "🔹 Понимание своих автоматических реакций:\n"
        "→ повышает вашу самоосознанность,\n"
        "→ помогает адаптироваться в сложных ситуациях.\n\n"
        "Чем лучше вы знаете свои паттерны, тем гибче можете реагировать там, где это нужно.\n\n"
        "_(P.S. Если после теста захотите разобрать результаты глубже — заглядывайте в мой телеграм-канал или задавайте вопросы)_"
    )
